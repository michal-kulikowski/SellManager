...
app_name = 'edit_app'
urlpatterns = [
    url(r'^show_ulotki_redirect/(?P<getIdFromRow>.*)$', views.show_ulotki_photos_redirect,
    ...
    url('update_ph', views.update_ph, name='update_ph'),
    ...
    url('rejestracja_ulotek_redirect/(?P<getIdFromRow>.*)$', views.rejestracja_ulotek_redirect,
        name='rejestracja_ulotek_redirect'),
    url('dodaj-informacje-klient', views.dodaj_informacje_klient, name='dodaj_informacje_klient'),
    url('opis-instalacji', views.opis_instalacji, name='opis_instalacji'),
